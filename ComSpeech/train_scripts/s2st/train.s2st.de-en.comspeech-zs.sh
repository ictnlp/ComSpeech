...
python fairseq/fairseq_cli/train.py data/comspeech/cvss_de_en/s2s \
    ...
    --st-data data/comspeech/cvss_de_en/speech2unigram --tts-data data/comspeech/cvss_x_en/tts/ \
    ...
    --load-pretrained-s2t-from ComSpeech/checkpoints/st.cvss.de-en.ctc/checkpoint_best.pt \
    --load-pretrained-ctc-from ComSpeech/checkpoints/st.cvss.de-en.ctc/checkpoint_best.pt \
