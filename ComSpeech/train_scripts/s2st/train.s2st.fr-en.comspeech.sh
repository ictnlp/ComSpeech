...
python fairseq/fairseq_cli/train.py data/comspeech/cvss_fr_en/s2s \
    ...
    --load-pretrained-s2t-from ComSpeech/checkpoints/st.cvss.fr-en/checkpoint_best.pt \
    --load-pretrained-fastspeech-from ComSpeech/checkpoints/tts.fastspeech2.cvss-fr-en/checkpoint_best.pt \
