...
python fairseq/fairseq_cli/train.py data/comspeech/cvss_de_en/s2s \
    ...
    --load-pretrained-s2t-from ComSpeech/checkpoints/st.cvss.de-en/checkpoint_best.pt \
    --load-pretrained-fastspeech-from ComSpeech/checkpoints/tts.fastspeech2.cvss-de-en/checkpoint_best.pt \
