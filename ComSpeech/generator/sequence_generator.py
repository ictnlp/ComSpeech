        ...
        for step in range(max_len + 1):  # one extra step for EOS marker
            ...
            if reorder_state is not None:
                ...
                self.model.reorder_incremental_state(
                    incremental_states, reorder_state, decoder,
                )
...
class EnsembleModel(EnsembleModelBase):
    ...
    def forward_decoder(
        ...
        for i, model in enumerate(self.models):
            ...
            probs = decoder.get_normalized_probs(
    ...
    def reorder_incremental_state(
        ...
        if not self.has_incremental_states():
            return
        decoder.reorder_incremental_state_scripting(
            incremental_states[0], new_order
        )
